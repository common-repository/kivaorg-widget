...
Plugin URI: http://wp.brahminacreations.com/kiva-wordpress-widget/
...
$kiva_api_app_id = "com.brahminacreations.kivawpwidget";
...
function widget_kiva_loan_init() {
	...
	wp_register_style( 'kww', plugins_url( 'style.css', __FILE__ ) );
    wp_enqueue_style( 'kww' );
...
?>
		<div>
			<p id="kiva_username_input">
				<label for="kiva_username">Kiva Lender Name:</label>
				<input id="kiva_username" name="kiva_username" type="text" value="<?php echo $username; ?>"> 
			</p>
			<p id="number_of_loans_input">
				<label for="number_of_loans">Number of loans (Min. 1):</label>
				<input id="number_of_loans" name="number_of_loans" type="text" value="<?php echo $number_of_loans; ?>"> 
			</p>
			<p id="number_of_loans_input">
				<label for="image_size">Image size (px or %):</label>
				<input id="image_size" name="image_size" type="text" value="<?php echo $image_size; ?>"> 
			</p>
